...
{
    public class RectangleSelectionCommand  : RoutedUICommand
    {
        public static RoutedUICommand MoveLeft  = new RoutedUICommand("MoveLeft",  "MoveLeft",  typeof(RectangleSelectionCommand));
        public static RoutedUICommand MoveUp    = new RoutedUICommand("MoveUp",    "MoveUp",    typeof(RectangleSelectionCommand));
        public static RoutedUICommand MoveRight = new RoutedUICommand("MoveRight", "MoveRight", typeof(RectangleSelectionCommand));
        public static RoutedUICommand MoveDown  = new RoutedUICommand("MoveDown",  "MoveDown",  typeof(RectangleSelectionCommand)); 
    }
