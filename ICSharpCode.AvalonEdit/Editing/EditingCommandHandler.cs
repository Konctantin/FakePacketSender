...
namespace ICSharpCode.AvalonEdit.Editing
{
    ...
    internal static class EditingCommandHandler
    {
        ...
        static EditingCommandHandler()
        {
            ...
            CommandBindings.Add(new CommandBinding(AvalonEditCommands.Comment, OnCommentSelection));
            CommandBindings.Add(new CommandBinding(AvalonEditCommands.UnComment, OnUnCommentSelection));
