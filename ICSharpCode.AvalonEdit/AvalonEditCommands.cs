...
namespace ICSharpCode.AvalonEdit
{
    ...
    public static class AvalonEditCommands
    {
        ...
        /// </summary>
        public static readonly RoutedCommand DeleteLine = new RoutedCommand("DeleteLine", typeof(TextEditor), new InputGestureCollection { new KeyGesture(Key.D, ModifierKeys.Control) });

        /// <summary>
        /// Removes leading whitespace from the selected lines (or the whole document if the selection is empty).
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly", MessageId = "Whitespace", Justification = "WPF uses 'Whitespace'")]
        ...
        /// </summary>
        public static readonly RoutedCommand IndentSelection = new RoutedCommand("IndentSelection", typeof(TextEditor), new InputGestureCollection { new KeyGesture(Key.I, ModifierKeys.Control) });

        /// <summary>
        /// Комментирует код
        /// </summary>
        public static readonly RoutedCommand Comment = new RoutedCommand("Comment", typeof(TextEditor), new InputGestureCollection { new KeyGesture(Key.K, ModifierKeys.Control) });
