...
namespace ICSharpCode.AvalonEdit.CodeCompletion
{
    ...
    public class InsightWindow : CompletionWindowBase
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(InsightWindow), new FrameworkPropertyMetadata(typeof(InsightWindow)));
            AllowsTransparencyProperty.OverrideMetadata(typeof(InsightWindow), new FrameworkPropertyMetadata(true));
        }
