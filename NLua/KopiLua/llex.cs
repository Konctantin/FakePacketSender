...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        */
        ...
        public static bool CurrIsNewline(LexState ls)
        {
            return (ls.current == '\n' || ls.current == '\r');
        }
        ...
        public static void SaveAndNext(LexState ls)
        {
        ...
        */
        ...
        private static void ReadString(LexState ls, int del, SemInfo seminfo)
        {
            SaveAndNext(ls);
