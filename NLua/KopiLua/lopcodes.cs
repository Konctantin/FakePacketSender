...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        */
        ...
        internal static uint MASK1(int n, int p)
        {
            return (uint)((~((~0) << n)) << p);
        }
        ...
        internal static uint MASK0(int n, int p)
        {
        ...
        */
        ...
        internal static int GETARG_A(InstructionPtr i)
        {
            return GETARG_A(i[0]);
        }
        ...
        internal static int GETARG_B(InstructionPtr i)
        {
            return GETARG_B(i[0]);
        }
        ...
        internal static int GETARG_C(InstructionPtr i)
        {
            return GETARG_C(i[0]);
        }
        ...
        internal static int GETARG_Bx(InstructionPtr i)
        {
        ...
        */
        ...
        internal static int RKASK(int x)
        {
            return x | BITRK;
        }
