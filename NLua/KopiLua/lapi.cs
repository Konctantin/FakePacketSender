...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        private static TValue Index2Address(LuaState L, int idx)
        {
            if (idx > 0)
            {
        ...
        */
        ...
        public static CharPtr LuaPushVFString(LuaState L, CharPtr fmt, object[] argp)
        {
            CharPtr ret;
            LuaLock(L);
            LuaCCheckGC(L);
        ...
        */
        ...
        private static void FunctionCall(LuaState L, object ud)
        {
            CallS c = ud as CallS;
        ...
        */
        ...
        private static void FunctionCCall(LuaState L, object ud)
        {
        ...
        */
        ...
        private static CharPtr AuxUpValue(StkId fi, int n, ref TValue val)
        {
            Closure f;
