...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        */
        ...
        internal static bool TTIsNil(Lua.LuaTypeValue o)
        {
            return (TType(o) == LUA_TNIL);
        }

        internal static bool TTIsNumber(Lua.LuaTypeValue o)
        {
            return (TType(o) == LUA_TNUMBER);
        }

        internal static bool TTIsString(Lua.LuaTypeValue o)
        {
            return (TType(o) == LUA_TSTRING);
        }

        internal static bool TTIsTable(Lua.LuaTypeValue o)
        {
            return (TType(o) == LUA_TTABLE);
        }

        internal static bool TTIsFunction(Lua.LuaTypeValue o)
        {
            return (TType(o) == LUA_TFUNCTION);
        }

        internal static bool TTIsBoolean(Lua.LuaTypeValue o)
        {
            return (TType(o) == LUA_TBOOLEAN);
        }

        internal static bool TTIsUserData(Lua.LuaTypeValue o)
        {
            return (TType(o) == LUA_TUSERDATA);
        }

        internal static bool TTIsThread(Lua.LuaTypeValue o)
        {
            return (TType(o) == LUA_TTHREAD);
        }

        internal static bool TTIsLightUserData(Lua.LuaTypeValue o)
        {
        ...
        internal static int TType(Lua.LuaTypeValue o)
        {
            return o.tt;
        }
        ...
        internal static GCObject GCValue(Lua.LuaTypeValue o)
        {
            return o.value.gc;
        }

        internal static object PValue(Lua.LuaTypeValue o)
        {
            return o.value.p;
        }

        internal static LuaNumberType NValue(Lua.LuaTypeValue o)
        {
            return o.value.n;
        }
        ...
        */
        ...
        internal static void SetObjs2S(LuaState L, Lua.LuaTypeValue obj, Lua.LuaTypeValue x)
        {
            SetObj(L, obj, x);
        }
        ...
        internal static void SetObj2S(LuaState L, Lua.LuaTypeValue obj, Lua.LuaTypeValue x)
        {
            SetObj(L, obj, x);
        }

        //#define setsvalue2s	setsvalue
        internal static void SetSValue2S(LuaState L, Lua.LuaTypeValue obj, TString x)
        {
            SetSValue(L, obj, x);
        }
        ...
        internal static void SetObjT2T(LuaState L, Lua.LuaTypeValue obj, Lua.LuaTypeValue x)
        {
            SetObj(L, obj, x);
        }
        ...
        internal static void SetObj2T(LuaState L, Lua.LuaTypeValue obj, Lua.LuaTypeValue x)
        {
            SetObj(L, obj, x);
        }
        ...
        */
        ...
        public static bool IsCFunction(Lua.LuaTypeValue o)
        {
        ...
        */
        ...
        public class Node : ArrayElement
        {
            ...
            {
                Debug.Assert(n1.values == n2.values); return n1.index > n2.index;
            }
        ...
        */
        ...
        internal static int TwoTo(int x)
        {
            return 1 << x;
        }

        internal static int SizeNode(Table t)
        {
