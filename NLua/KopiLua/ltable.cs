...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        */
        ...
        internal static TKeyNK gkey(Node n)
        {
            return n.i_key.nk;
        }

        internal static TValue gval(Node n)
        {
            return n.i_val;
        }

        internal static Node gnext(Node n)
        {
            return n.i_key.nk.next;
        }

        internal static void gnext_set(Node n, Node v)
        {
            n.i_key.nk.next = v;
        }

        internal static TValue key2tval(Node n)
        {
            return n.i_key.tvk;
        }
        ...
        */
        ...
        internal static Node hashpow2(Table t, lua_Number n)
        {
        ...
        */
        ...
        {
            return gnode(t, (int)((uint)n % ((SizeNode(t) - 1) | 1)));
        }
