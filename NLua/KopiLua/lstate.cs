...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        public static TValue Gt(LuaState L)
        {
            return L.l_gt;
        }
        ...
        public static TValue Registry(LuaState L)
        {
        ...
        */
        ...
        public static Closure CurrFunc(LuaState L)
        {
        ...
        */
        ...
        public static GlobalState G(LuaState L)
        {
            return L.l_G;
        }
        ...
        */
        ...
        {
            return (TString)CheckExp(o.gch.tt == LUA_TSTRING, o.ts);
        }
        ...
        {
            return (Udata)CheckExp(o.gch.tt == LUA_TUSERDATA, o.u);
        }
        ...
        {
            return (Closure)CheckExp(o.gch.tt == LUA_TFUNCTION, o.cl);
        }

        public static Table gco2h(GCObject o)
        {
            return (Table)CheckExp(o.gch.tt == LUA_TTABLE, o.h);
        }

        public static Proto gco2p(GCObject o)
        {
            return (Proto)CheckExp(o.gch.tt == LUATPROTO, o.p);
        }

        public static UpVal gco2uv(GCObject o)
        {
            return (UpVal)CheckExp(o.gch.tt == LUATUPVAL, o.uv);
        }

        public static UpVal ngcotouv(GCObject o)
        {
            return (UpVal)CheckExp((o == null) || (o.gch.tt == LUATUPVAL), o.uv);
        }

        public static LuaState gco2th(GCObject o)
        {
            return (LuaState)CheckExp(o.gch.tt == LUA_TTHREAD, o.th);
        }
        ...
        {
            return Marshal.SizeOf(x) + LUAI_EXTRASPACE;
        }
