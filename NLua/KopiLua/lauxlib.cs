...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        public static int LuaLGetN(LuaState L, int i)
        {
            return (int)LuaObjectLen(L, i);
        }

        public static void LuaLSetN(LuaState L, int i, int j)
        {
        } /* no op! */
        ...
        */
        ...
        public static CharPtr LuaLCheckString(LuaState L, int n)
        {
            return LuaLCheckLString(L, n);
        }

        public static CharPtr LuaLOptString(LuaState L, int n, CharPtr d)
        {
            uint len; return LuaLOptLString(L, n, d, out len);
        }

        public static int LuaLCheckInt(LuaState L, int n)
        {
            return (int)LuaLCheckInteger(L, n);
        }
        ...
        public static long LuaLCheckLong(LuaState L, int n)
        {
            return LuaLCheckInteger(L, n);
        }
        ...
        public static CharPtr LuaLTypeName(LuaState L, int i)
        {
            return LuaTypeName(L, LuaType(L, i));
        }
        ...
        public static void LuaLGetMetatable(LuaState L, CharPtr n)
        {
            LuaGetField(L, LUA_REGISTRYINDEX, n);
        }
        ...
        */
        ...
        public static CharPtr LuaLCheckLString(LuaState L, int narg)
        {
            uint len; return LuaLCheckLString(L, narg, out len);
        }
        ...
        */
        ...
        private static CharPtr GetS(LuaState L, object ud, out uint size)
        {
            LoadS ls = (LoadS)ud;
            //(void)L;
