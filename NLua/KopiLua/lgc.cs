...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        */
        ...
        public static int LSetBit(ref LuaByteType x, int b)
        {
        ...
        public static int Set2Bits(ref LuaByteType x, int b1, int b2)
        {
        ...
        */
        ...
        {
            LSetBit(ref x.gch.marked, BLACKBIT);
        }
        ...
        public static void LuaCBarrier(LuaState L, object p, TValue v)
        {
            if (ValIsWhite(v) && IsBlack(obj2gco(p)))
                LuaCBarrierF(L, obj2gco(p), GCValue(v));
        }

        public static void LuaCBarrierT(LuaState L, Table t, TValue v)
        {
        ...
        public static bool IsFinalized(UdataUV u)
        {
        ...
        */
        ...
        public static void SweepWholeList(LuaState L, GCObjectRef p)
        {
            SweepList(L, p, MAXLUMEM);
        }
        ...
        private static void CheckSizes(LuaState L)
        {
            ...
            if (luaZ_sizebuffer(g.buff) > LUAMINBUFFER * 2)
            {  /* buffer too big? */
