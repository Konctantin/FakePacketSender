...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        public static FilePtr ToFilePointer(LuaState L)
        {
            return (FilePtr)LuaLCheckUData(L, 1, LUA_FILEHANDLE);
        }
        ...
        */
        ...
        private static int IoReadLine(LuaState L)
        {
            ...
            {  /* EOF */
                if (LuaToBoolean(L, LuaUpValueIndex(2)) != 0)
        ...
        {
            int result = 1;
            try { GetIOFile(L, IOOUTPUT).Flush(); }
            catch { result = 0; }
