...
namespace KopiLua
{
    ...
    public partial class Lua
    {
        ...
        */
        ...
        public static bool luai_numlt(lua_Number a, lua_Number b)
        {
            return ((a) < (b));
        }
        ...
        */
        ...
        public class LuaException : Exception
        {
            ...
            public LuaException(LuaState L, LuaLongJmp c)
            {
                this.L = L; this.c = c;
            }
        }
        ...
        */
        ...
        ///* C++ exceptions */
        public static void LUAI_THROW(LuaState L, LuaLongJmp c)
        {
		...
		*/
        ...
        public static Stream LuaPopen(LuaState L, CharPtr c, CharPtr m)
        {
            LuaLError(L, LUA_QL("popen") + " not supported"); return null;
        }

        public static int LuaPClose(LuaState L, Stream file)
        {
            return 0;
        }
